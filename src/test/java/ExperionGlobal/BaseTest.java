...
public class BaseTest  {
    ...
    public static void startTest() throws MalformedURLException
	{
        ...
        report = new com.relevantcodes.extentreports.ExtentReports(System.getProperty("user.dir")+"/Appium/target/Reports"+timeStamp.replace(":","_").replace(":","_")+".html");
		test = report.startTest("Amazon App Product Search");
		report.loadConfig(new File(System.getProperty("user.dir") + "/Appium/target/extent-config.xml"));
	    ...
	    public void getResult(ITestResult result){
	        if(result.getStatus()==ITestResult.FAILURE){
				...
				try {
					...
					File destinationPath = new File(System.getProperty("user.dir") + "/Appium/target/Screenshots" + "screenshotName"+ timeStamp.replace(":","_").replace(":","_") + ".png");
